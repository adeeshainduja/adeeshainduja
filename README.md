...
<h3 align="center">
  Software Engineering Undergraduate | Data Engineering & Automation Enthusiast
</h3>
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=python,c,java,js,ts,html,css,bootstrap,react,nextjs,nodejs,express,mongodb,mysql,postgres,firebase,git,github,vscode,postman,docker" />
</p>
...
End-to-end data engineering pipeline for cleaning, storing, analyzing, and visualizing customer support ticket data.

**Tech Stack:** Python, Pandas, SQL, PostgreSQL, Streamlit  
**Focus Areas:** ETL, Data Cleaning, SQL Analysis, Analytics Dashboard

---

### 🔹 Job Market Data Pipeline with n8n

Automation workflow for collecting and organizing job and internship market data using n8n and APIs.

**Tech Stack:** n8n, APIs, Google Sheets, Automation  
**Focus Areas:** Workflow Automation, API Integration, Job Data Tracking

---

### 🔹 AI-Powered Image Super Resolution System

AI-based full-stack system for improving low-resolution and noisy images using image enhancement techniques.

**Tech Stack:** AI/ML, JavaScript, Docker, Backend, Frontend  
**Focus Areas:** Image Enhancement, Full-stack Development, Containerized Deployment

---

### 🔹 EventHive Event Booking Platform

Full-stack event booking and venue management platform with authentication, admin features, and modern UI.

**Tech Stack:** React, Node.js, Express.js, MySQL  
**Focus Areas:** Full-stack Development, Authentication, Booking System

---

### 🔹 Heart Disease Prediction Web App

Machine learning web application that predicts heart disease risk using a trained ML model.

**Tech Stack:** Python, Flask, Machine Learning, TypeScript  
**Focus Areas:** ML Model Integration, Prediction System, Web Application
...
<p align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=adeeshainduja&show_icons=true&theme=tokyonight" alt="Adeesha's GitHub Stats" />
</p>
...
<p align="center">
  <img src="https://github-readme-activity-graph.vercel.app/graph?username=adeeshainduja&theme=tokyo-night" alt="Contribution Graph" />
</p>
